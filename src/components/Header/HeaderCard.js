export default function HeaderCard() {
    return (
        <div
            className="flex flex-col justify-between rounded-lg w-full bg-white bg-opacity-10 ring-1 ring-inset ring-opacity-10 ring-white"
        ...
        >
            <div className="w-full flex pt-4 pb-3 px-4 border-b border-white border-opacity-10">
                ...
                <div className="m-auto text-sm text-white text-shadow-md">Testimonials.app</div>
            </div>
